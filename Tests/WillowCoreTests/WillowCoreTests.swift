...
class WillowCoreTests: XCTestCase {
    ...
    /// Keep this here for a reference of what goes into testing with
    /// a temporary directory and all.
    /// But we need to take it out since the output of the whole program
    /// isn't just the input run through a lexer.
